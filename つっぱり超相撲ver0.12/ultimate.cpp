...
void CUltimate::Init(void)
{
	...
	if (m_pPlayer == NULL)
	{// プレイヤー
		m_pPlayer = CPlayer::Create(D3DXVECTOR3(-150.0f, 50.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
	}

	if (m_pEnemy == NULL)
	{// エネミー
		m_pEnemy = CEnemy::Create(D3DXVECTOR3(150.0f, 50.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
	}
